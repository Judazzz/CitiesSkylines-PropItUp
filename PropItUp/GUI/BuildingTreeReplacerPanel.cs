...
namespace PropItUp.GUI
{
    public class BuildingTreeReplacerPanel : UIPanel
    {
        ...
        private void SetupControls()
        {
            ...
            _titleLabel.text = "Global building tree replacement";
            ...
            _resetReplacementButton.eventClicked += (c, e) =>
            {
                ...
                Configuration.PrefabReplacement replacement = PropItUpTool.config.GetGlobalBuildingReplacementByTreeName(_selectedTreeOriginal.name);
                //  Restore replacement:
        ...
        protected void OnSelectedOriginalChanged(UIComponent component, int i)
        {
            ...
            if (PropItUpTool.config.GetGlobalBuildingReplacementByTreeName(_selectedTreeOriginal.name) != null)
            {
                _resetReplacementButton.isEnabled = true;
            }
            else
        ...
        public void SearchOriginal()
        {
            ...
            if (PropItUpTool.config.enable_debug)
            {
                DebugUtils.Log($"BuildingTreeReplacerPanel: originalFastList search query '{originalSearchQuery}' returned {tmpItemList.Count} results.");
            }
        }
        ...
        public void SearchReplacement()
        {
            ...
            if (PropItUpTool.config.enable_debug)
            {
                DebugUtils.Log($"BuildingTreeReplacerPanel: replacementFastList search query '{replacementSearchQuery}' returned {tmpItemList.Count} results.");
            }
        }
